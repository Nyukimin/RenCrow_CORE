...
| `cmd/rencrow/main.go` | ConversationConfig読込、StubConversationManager初期化、MioAgentへの注入 | buildDependencies() のみ |
...
import (
	...
	"github.com/Nyukimin/RenCrow_CORE/internal/domain/conversation"  // 新規import
...
### 7.1 buildDependencies()修正（`cmd/rencrow/main.go`）
...
func TestConfig_ConversationDefaults(t *testing.T) {
	...
	assert.Equal(t, "/var/lib/rencrow/memory.duckdb", cfg.Conversation.DuckDBPath)
...
$ RENCROW_CONFIG=config.test.yaml go run cmd/rencrow/main.go
...
- [ ] `/home/nyukimi/RenCrow_CORE/internal/domain/conversation/message.go`
- [ ] `/home/nyukimi/RenCrow_CORE/internal/domain/conversation/thread.go`
- [ ] `/home/nyukimi/RenCrow_CORE/internal/domain/conversation/session_conversation.go`
- [ ] `/home/nyukimi/RenCrow_CORE/internal/domain/conversation/thread_summary.go`
- [ ] `/home/nyukimi/RenCrow_CORE/internal/domain/conversation/agent_status.go`
- [ ] `/home/nyukimi/RenCrow_CORE/internal/domain/conversation/manager.go`
- [ ] `/home/nyukimi/RenCrow_CORE/internal/domain/conversation/errors.go`
- [ ] `/home/nyukimi/RenCrow_CORE/internal/infrastructure/persistence/conversation/stub_manager.go`
- [ ] `/home/nyukimi/RenCrow_CORE/internal/domain/agent/mio.go`（修正）
- [ ] `/home/nyukimi/RenCrow_CORE/internal/adapter/config/config.go`（修正）
- [ ] `/home/nyukimi/RenCrow_CORE/cmd/rencrow/main.go`（修正）

#### テストファイル

- [ ] `/home/nyukimi/RenCrow_CORE/internal/domain/conversation/message_test.go`
- [ ] `/home/nyukimi/RenCrow_CORE/internal/domain/conversation/thread_test.go`
- [ ] `/home/nyukimi/RenCrow_CORE/internal/domain/conversation/agent_status_test.go`
- [ ] `/home/nyukimi/RenCrow_CORE/internal/infrastructure/persistence/conversation/stub_manager_test.go`
- [ ] `/home/nyukimi/RenCrow_CORE/internal/adapter/config/config_test.go`（追加テスト）
- [ ] `/home/nyukimi/RenCrow_CORE/internal/domain/agent/mio_test.go`（追加テスト）
