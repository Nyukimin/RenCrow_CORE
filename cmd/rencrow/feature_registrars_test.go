...
func TestRegisterFeatureRoutesKeepsExistingRouteGroups(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "X Bookmark page", method: http.MethodGet, path: "/viewer/x-bookmarks", want: http.StatusOK},
		...
		{name: "viewer games decision", method: http.MethodPost, path: "/viewer/games/decision", want: http.StatusCreated},
