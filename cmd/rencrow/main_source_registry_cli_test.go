...
<item><title>AI Update</title><link>https://example.com/ai</link><description>RenCrow_LLM Gateway news</description><pubDate>Tue, 05 May 2026 10:00:00 GMT</pubDate></item>
</channel></rss>`))
	}))
	defer srv.Close()
