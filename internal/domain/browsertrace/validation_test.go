...
func TestValidateBrowserTraceRequiredFields(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "artifact title", err: ValidateAPIArtifact(APIArtifact{ArtifactID: "art_1", TaskID: "tsk_00000000-0000-5000-8000-000000000001", RunID: "run_00000000-0000-5000-8000-000000000002", ActorID: "mio", Type: "observed_openapi", Status: "generated", Content: "openapi: 3.1.0", CreatedAt: now}), want: "title"},
		{name: "artifact status", err: ValidateAPIArtifact(APIArtifact{ArtifactID: "art_1", TaskID: "tsk_00000000-0000-5000-8000-000000000001", RunID: "run_00000000-0000-5000-8000-000000000002", ActorID: "mio", Type: "observed_openapi", Title: "Observed OpenAPI", Content: "openapi: 3.1.0", CreatedAt: now}), want: "status"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
