...
// parseChatResponse はRenCrow_LLM Gateway chat completionsレスポンスをパースする
func (p *GatewayProvider) parseChatResponse(body io.Reader) (llm.ChatResponse, error) {
	...
	if err := json.NewDecoder(body).Decode(&gatewayResp); err != nil {
