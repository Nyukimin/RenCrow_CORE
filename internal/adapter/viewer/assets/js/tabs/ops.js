...
function renderOps() {
  ...
  feed.forEach((ev) => {
    ...
    const levelClass = opsEventLevelClass(level);
    const ageClass = opsEventAgeClass(ev.timestamp);
...
function opsEventAgeClass(createdAt) {
...
function opsEventLevelClass(levelValue) {
