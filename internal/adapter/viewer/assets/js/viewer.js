...
const userMemoryStateFilter = document.getElementById('userMemoryStateFilter');
const userMemoryQuery = document.getElementById('userMemoryQuery');
const userMemorySearchBtn = document.getElementById('userMemorySearchBtn');
const userMemoryPrevBtn = document.getElementById('userMemoryPrevBtn');
const userMemoryNextBtn = document.getElementById('userMemoryNextBtn');
...
if (userMemorySearchBtn) userMemorySearchBtn.addEventListener('click', resetAndRefreshUserMemory);
if (userMemoryStateFilter) userMemoryStateFilter.addEventListener('change', resetAndRefreshUserMemory);
if (userMemoryQuery) userMemoryQuery.addEventListener('keydown', (e) => { if (e.key === 'Enter') resetAndRefreshUserMemory(); });
if (userMemoryPrevBtn) userMemoryPrevBtn.addEventListener('click', previousUserMemoryPage);
if (userMemoryNextBtn) userMemoryNextBtn.addEventListener('click', nextUserMemoryPage);
