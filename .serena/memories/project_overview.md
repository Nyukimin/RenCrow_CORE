...
## プロジェクトの目的
RenCrow は超軽量なパーソナル AI アシスタントです。Go 言語で実装され、<10MB のメモリ使用量で $10 ハードウェア上でも動作することを目標としています。
...
- `cmd/rencrow-agent/` - Agentスタンドアロンモード
...
- `cmd/rencrow-agent/main.go` - スタンドアロンモード
