...
func TestStep20IdentityCleanupLegacyTokensAreBanned(t *testing.T) {
	...
	owners := []struct {
		...
		{"internal/adapter/viewer/monitor_types.go", step19Tokens},
		{"internal/adapter/viewer/monitor_reducers.go", step19Tokens},
		{"internal/adapter/viewer/monitor_queries.go", step19Tokens},
		{"internal/adapter/viewer/monitor_handler.go", step19Tokens},
		{"internal/adapter/viewer/canonical_event_log.go", step19Tokens},
		{"internal/application/orchestrator/event.go", step19Tokens},
