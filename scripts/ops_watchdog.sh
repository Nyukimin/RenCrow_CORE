...
RENCROW_HOME="$(expand_home "${RENCROW_HOME:-$HOME/.rencrow}")"
LOG_DIR="$(expand_home "${RENCROW_WATCHDOG_LOG_DIR:-$RENCROW_HOME/logs}")"
LOG_FILE="$(expand_home "${RENCROW_WATCHDOG_LOG_FILE:-$LOG_DIR/ops-watchdog.log}")"

REN_CROW_URL="${RENCROW_WATCHDOG_RENCROW_URL:-http://127.0.0.1:18790}"
HEALTH_URL="${RENCROW_WATCHDOG_HEALTH_URL:-${REN_CROW_URL}/health}"
TAILSCALE_HOST="${RENCROW_WATCHDOG_TAILSCALE_HOST:-fujitsu-ubunts.tailb07d8d.ts.net}"
VIEWER_URL="${RENCROW_WATCHDOG_VIEWER_URL:-https://${TAILSCALE_HOST}/viewer?tab=timeline}"
SERVE_TARGET="${RENCROW_WATCHDOG_SERVE_TARGET:-${REN_CROW_URL}}"
