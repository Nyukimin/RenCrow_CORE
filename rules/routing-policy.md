...
対象：
- 汎用コーディング依頼
- まだ CODE1/CODE2/CODE3/CODE4 の切り分けが不要な実装依頼

担当：
- Coder
- 必要に応じて内部で CODE1/CODE2/CODE3/CODE4 相当へ振り分ける
...
Coder1 / Coder2 / Coder3 / Coder4 の外部 API は `/code1` / `/code2` / `/code3` / `/code4` などの明示指定時のみ使う。汎用 `/code` は外部 Coder を使わず、外部 Coder へ自動切替しない。
