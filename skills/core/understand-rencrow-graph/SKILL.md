# Understand RenCrow Graph

## Purpose

`RenCrow_CORE` に Understand Anything を適用し、`.understand-anything/knowledge-graph.json` と dashboard を更新・確認する。

## When to Use

- ユーザーが「understand を RenCrow_CORE に適用」「knowledge graph を更新」「architecture graph を見たい」と依頼した。
- 大規模調査の前に codebase graph を更新する。

## Required Context

- project root: `/home/nyukimi/RenCrow/RenCrow_CORE`
