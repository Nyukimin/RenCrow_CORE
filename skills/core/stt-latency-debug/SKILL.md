...
- `RenCrow_STT` と `RenCrow_CORE/modules/stt` のどちらが owner か曖昧。
- Viewer voice input の実ブラウザ確認が必要。

## Ownership

- STT engine / model / transcription owner: `/home/nyukimi/RenCrow/RenCrow_STT`
- Core runtime gateway / Viewer integration owner: `/home/nyukimi/RenCrow/RenCrow_CORE`
...
6. live service 反映が必要なら `rencrow-service-rebuild-restart` を使う。
