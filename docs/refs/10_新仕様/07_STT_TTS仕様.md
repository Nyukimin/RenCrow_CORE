...
| 領域 | 主担当 |
| --- | --- |
| STT runtime factory | `cmd/rencrow/stt_runtime_factory.go` |
| STT runtime config | `cmd/rencrow/stt_runtime_config.go` |
| STT WebSocket | `cmd/rencrow/stt_runtime_websocket.go` |
| STT HTTP / audio | `cmd/rencrow/stt_runtime_http.go`, `cmd/rencrow/stt_runtime_audio.go` |
| STT provider | `internal/infrastructure/stt` |
| route registration | `cmd/rencrow/routes.go` |
...
| 領域 | 主担当 |
| --- | --- |
| TTS runtime factory | `cmd/rencrow/tts_runtime_factory.go` |
| IdleChat TTS queue / pending / voice | `cmd/rencrow/idlechat_tts*.go` |
...
| lipsync / VTuber | `internal/infrastructure/vtuber`, `cmd/rencrow/tts_vtuber_lipsync.go`, `cmd/rencrow/vtuber_bridge.go` |
...
```bash
GOCACHE=/tmp/rencrow-gocache go test ./internal/infrastructure/stt ./cmd/rencrow
```

TTS:

```bash
GOCACHE=/tmp/rencrow-gocache go test ./internal/infrastructure/tts ./internal/infrastructure/audiorouter ./cmd/rencrow
```
