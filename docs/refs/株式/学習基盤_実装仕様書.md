...
この仕様書は、RenCrow / RenCrow_CORE に株式・ETF向けの AI トレーディング学習基盤を追加するための実装仕様である。source of truth は `docs/株式/株式_学習基盤.md` と `docs/株式/株式_アルゴリズム評価.md`、および株式プロンプト群のうち戦略、バックテスト、リスク、データ、ライブ基盤、コンプライアンス関連文書である。
