...
表中の `docs/refs/10_新仕様/...` は補助参照であり、通常入口ではありません。仕様判断で迷った場合は `02_正本仕様/00_正本仕様Tree.md` から対象正本を選び、補助参照が必要な場合だけ該当資料を確認します。
...
| 主な参照 | `02_正本仕様/02_実装仕様.md`, `docs/refs/10_新仕様/04_Chat_Worker_Coder仕様.md`, `workspace/persona/aka.md` |
...
| 主な参照 | `02_正本仕様/02_実装仕様.md`, `docs/refs/10_新仕様/04_Chat_Worker_Coder仕様.md`, `workspace/persona/ao.md` |
...
| 主な参照 | `02_正本仕様/02_実装仕様.md`, `docs/refs/10_新仕様/04_Chat_Worker_Coder仕様.md`, `workspace/persona/gin.md` |
...
| 主な参照 | `02_正本仕様/02_実装仕様.md`, `docs/refs/10_新仕様/04_Chat_Worker_Coder仕様.md`, `workspace/persona/kin.md` |
...
| 主な参照 | `docs/refs/10_新仕様/26_Persona_Lore_and_Mutual_Observation仕様.md`, `internal/domain/agent/heavy.go` |
...
| 主な参照 | `docs/refs/10_新仕様/26_Persona_Lore_and_Mutual_Observation仕様.md`, `internal/domain/agent/wild.go` |
