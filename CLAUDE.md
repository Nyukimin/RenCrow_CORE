...
- ❌ **削除済みの旧 docs / archive / old / codebase-map を参照する**（必要な内容は正本仕様または `docs/10_新仕様/` に統合する）
...
2. **実装仕様確認**: `docs/01_正本仕様/実装仕様.md` を参照（必要に応じて v4/v5/v5.1 も）
...
- **実装仕様 v3.0**: `docs/01_正本仕様/実装仕様.md`（Clean Architecture実装の一次参照）
